...
ENTITY 	practica5c IS
    PORT (
	clk50M : IN std_logic;
	bout : BUFFER std_logic_vector(4 DOWNTO 0);
	start : IN std_logic
	);
END practica5c;

-- Design Ports Information
-- bout[0]	=>  Location: PIN_143,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- bout[1]	=>  Location: PIN_3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- bout[2]	=>  Location: PIN_2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- bout[3]	=>  Location: PIN_1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- bout[4]	=>  Location: PIN_7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \u1|contador~15_combout\ : std_logic;
...
\u1|contador~15\ : cycloneive_lcell_comb
-- Equation(s):
-- \u1|contador~15_combout\ = (\u1|Add0~0_combout\ & (((!\u1|Equal0~6_combout\) # (!\u1|Equal0~4_combout\)) # (!\u1|Equal0~5_combout\)))
...
PORT MAP (
	...
	combout => \u1|contador~15_combout\);
...
-- Equation(s):
-- \u1|contador~11_combout\ = (\u1|Add0~14_combout\ & (((!\u1|Equal0~6_combout\) # (!\u1|Equal0~4_combout\)) # (!\u1|Equal0~5_combout\)))
...
-- Equation(s):
-- \u1|Equal0~1_combout\ = (!\u1|contador\(1) & (!\u1|contador\(0) & (\u1|contador\(7) & !\u1|contador\(4))))
...
-- Equation(s):
-- \u1|Equal0~0_combout\ = (!\u1|contador\(2) & (!\u1|contador\(5) & (!\u1|contador\(3) & !\u1|contador\(6))))
...
-- Equation(s):
-- \u1|Equal0~2_combout\ = (!\u1|contador\(10) & (!\u1|contador\(11) & (!\u1|contador\(9) & !\u1|contador\(8))))
...
-- Equation(s):
-- \u1|contador~10_combout\ = (\u1|Add0~24_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
-- Equation(s):
-- \u1|contador~8_combout\ = (\u1|Add0~26_combout\ & (((!\u1|Equal0~6_combout\) # (!\u1|Equal0~5_combout\)) # (!\u1|Equal0~4_combout\)))
...
-- Equation(s):
-- \u1|contador~12_combout\ = (\u1|Add0~28_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
-- Equation(s):
-- \u1|contador~13_combout\ = (\u1|Add0~30_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
-- Equation(s):
-- \u1|Equal0~3_combout\ = (\u1|contador\(14) & (\u1|contador\(15) & (\u1|contador\(12) & \u1|contador\(13))))
...
-- Equation(s):
-- \u1|contador~9_combout\ = (\u1|Add0~38_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
\u1|contador~18\ : cycloneive_lcell_comb
-- Equation(s):
-- \u1|contador~18_combout\ = (\u1|Add0~40_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
PORT MAP (
	...
	combout => \u1|contador~18_combout\);
...
\u1|contador~16\ : cycloneive_lcell_comb
-- Equation(s):
-- \u1|contador~16_combout\ = (\u1|Add0~44_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
PORT MAP (
	...
	combout => \u1|contador~16_combout\);
...
\u1|contador~17\ : cycloneive_lcell_comb
-- Equation(s):
-- \u1|contador~17_combout\ = (\u1|Add0~46_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
PORT MAP (
	...
	datad => \u1|Equal0~4_combout\,
	combout => \u1|contador~17_combout\);
...
-- Equation(s):
-- \u1|Equal0~6_combout\ = (\u1|contador\(21) & (\u1|contador\(23) & (\u1|contador\(20) & \u1|contador\(22))))
...
PORT MAP (
	...
	datad => \u1|contador\(22),
	combout => \u1|Equal0~6_combout\);

-- Location: LCCOMB_X24_Y20_N30
\u1|contador~14\ : cycloneive_lcell_comb
-- Equation(s):
-- \u1|contador~14_combout\ = (\u1|Add0~34_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
PORT MAP (
	...
	datad => \u1|Equal0~4_combout\,
	combout => \u1|contador~14_combout\);
...
-- Equation(s):
-- \u1|Equal0~5_combout\ = (\u1|contador\(17) & (!\u1|contador\(18) & (\u1|contador\(19) & !\u1|contador\(16))))
...
\u1|contador~19\ : cycloneive_lcell_comb
-- Equation(s):
-- \u1|contador~19_combout\ = (\u1|Add0~42_combout\ & (((!\u1|Equal0~4_combout\) # (!\u1|Equal0~6_combout\)) # (!\u1|Equal0~5_combout\)))
...
PORT MAP (
	...
	combout => \u1|contador~19_combout\);
...
-- Equation(s):
-- \u1|clkout~0_combout\ = (\u1|contador\(19)) # ((\u1|contador\(20)) # ((\u1|contador\(17) & \u1|contador\(18))))
...
-- Equation(s):
-- \u1|clkout~1_combout\ = (!\u1|contador\(22) & (!\u1|contador\(23) & ((!\u1|clkout~0_combout\) # (!\u1|contador\(21)))))
...
-- Equation(s):
-- \u1|LessThan0~0_combout\ = (\u1|contador\(20)) # ((\u1|contador\(23)) # ((\u1|contador\(19)) # (\u1|contador\(22))))
...
-- Equation(s):
-- \u1|LessThan0~1_combout\ = (((!\u1|contador\(6) & !\u1|contador\(5))) # (!\u1|contador\(7))) # (!\u1|contador\(8))
...
-- Equation(s):
-- \u1|LessThan0~2_combout\ = (\u1|contador\(12)) # ((\u1|contador\(10) & ((\u1|contador\(9)) # (!\u1|LessThan0~1_combout\))))
...
-- Equation(s):
-- \u1|LessThan0~3_combout\ = (!\u1|LessThan0~0_combout\ & (((!\u1|contador\(11) & !\u1|LessThan0~2_combout\)) # (!\u1|contador\(13))))
...
-- Equation(s):
-- \u1|LessThan0~4_combout\ = (!\u1|contador\(15) & (!\u1|contador\(16) & (!\u1|contador\(14) & \u1|LessThan0~3_combout\)))
...
-- Equation(s):
-- \contador~1_combout\ = (contador(1) & ((contador(2)) # (!contador(0)))) # (!contador(1) & ((contador(0))))
...
-- Equation(s):
-- \contador~0_combout\ = ((contador(2) & contador(1))) # (!contador(0))
...
-- Equation(s):
-- \Mux3~0_combout\ = (!contador(0) & (!contador(2) & !contador(1)))
...
-- Equation(s):
-- \Mux0~0_combout\ = ((!contador(1) & !contador(0))) # (!contador(2))
